...
\title{A technique for constrained optimization of symmetric laminates using a new variant of the genetic algorithm}
\author[]{Huiyao Zhang}
...
\captionof{table}{Comparison of the carbon/epoxy, graphite/epoxy, and glass/epoxy properties}
\begin{adjustbox}{width={\textwidth},totalheight={\textheight},keepaspectratio}

...
\title{An approximation method of strength ratio calculation of laminated composite material based on evolutionary artificial neural network}
...
\begin{IEEEkeywords}
Classic Lamination Theory; Genetic Algorithm; Artificial neural network;
Optimization
\end{IEEEkeywords}
...
\input{src/a1_introduction_part1}
\input{src/a1_introduction_part2_composite}
\input{src/a1_introduction_part3_ann}
\input{src/a2_methodology}
\input{src/a3_experiment}
\input{src/a3_result}
\input{src/a4_conclusion}
\input{src/a5_acknowledge}

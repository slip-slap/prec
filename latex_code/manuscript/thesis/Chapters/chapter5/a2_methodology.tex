...
\input{Figures/chapter5/fig/a0_figure_ann_for_clt_architecture.tex}
\begin{figure}[!tb]
	\centering
	\begin{subfigure}[b]{1.0\linewidth}
		\centering
		\input{Figures/chapter5/fig/experiment_architecture_example1_code.tex}
		\caption{Parent 1}
	\end{subfigure}
	\newline
	\begin{subfigure}[b]{1.0\linewidth}
		\centering
		\input{Figures/chapter5/fig/experiment_architecture_example2_code.tex}
		\caption{Parent 2}
	\end{subfigure}
	\newline
	\begin{subfigure}[b]{1.0\linewidth}
		\centering
		\input{Figures/chapter5/fig/experiment_architecture_child_code.tex}
		\caption{Child}
	\end{subfigure}
	\caption{Examples of three ANNs, with (a) and (b) as parent ANNs, and (c) as
		...
		\label{fig:anns}
\end{figure}
\input{Figures/chapter5/fig/experiment_architecture_example1_table.tex}

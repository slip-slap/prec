...
fitness_low = result.coeff_low_fitness_
strength_raito_low = result.coeff_low_strength_ratio_

fitness_high = result.coeff_high_fitness_
strength_raito_high = result.coeff_high_strength_ratio_

x_coordinate = list(np.arange(1,cv.GA_RUNTIMES+2,1))
...
ax1.set_ylim([0,max(fitness_low)+2])
